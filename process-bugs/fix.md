...
Read `bug-working.md` in full, paying close attention to `## Reproduction Steps`.
...
in `bug-working.md`. Be specific: file path, function name, and a brief explanation of
...
Under `## Fix Applied` in `bug-working.md`, write:
