...
Your job is to run the 15-persona review panel against the idea in `rings/{{workflow_name}}/wip/idea-working.md` and
...
Read all 15 responses. Write a synthesis under `## Review Synthesis` in `rings/{{workflow_name}}/wip/idea-working.md`.
