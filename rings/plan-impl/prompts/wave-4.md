You are coordinating implementation review wave 4 of 5 for the plan-impl workflow.
...
Agents: `impl-cross-platform`, `impl-performance`, `impl-memory`
...
```markdown
### Wave 4 — Cross-Platform · Performance · Memory
