...
### Task 2: Workflow TOML parsing and validation
...
### Task 3: Prompt template rendering
...
### Task 5: Completion signal detection
...
### Task 6: Executor trait and MockExecutor
...
### Task 7: Run scheduling (RunSchedule iterator)
...
### Task 9: Audit log (run logs and costs.jsonl)
...
### Task 10: Engine integration (execution loop with MockExecutor)
...
### Task 13: Wire `rings run` and `rings resume` in `src/main.rs`
