You are coordinating implementation review wave 2 of 5 for the plan-impl workflow.
...
Agents: `impl-testing`, `impl-error-handling`, `impl-cli-framework`
...
```markdown
### Wave 2 — Testing · Error Handling · CLI Framework
