...
- [ ] **Step 1: Replace `expect()` on `ctrlc::set_handler` with `?` propagation**
...
- [ ] **Step 2: Verify no other `unwrap()` or `expect()` were introduced in Task 14**
...
- [ ] **Step 1: Thread the `canceled` flag into `run_workflow`**
...
- [ ] **Step 2: Save state and print cancellation summary on SIGINT**
...
- [ ] **Step 3: Propagate exit code 130 from `cmd_run` / `cmd_resume`**
...
- [ ] **Step 4: Write an integration test covering SIGINT cancellation**
...
- [ ] **Step 1: Add `lazy_static = "1.4"` to `Cargo.toml` dependencies**
...
- [ ] **Step 2: Refactor `src/cost.rs` to use lazy_static**
...
- [ ] **Step 3: Verify the code still compiles and tests pass**
...
- [ ] **Step 1: Add test configuration to `Cargo.toml`**
...
- [ ] **Step 2: Add the [[test]] configuration to Cargo.toml**
...
- [ ] **Step 3: Verify `cargo test` now compiles without `--features testing`**
